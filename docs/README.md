...
Domain Health Inspector is a focused domain health inspection app for personal websites, APIs, home services, parked domains, and small team assets.
...
## What Domain Health Inspector Checks

Domain Health Inspector brings several common domain checks into one app:
...
Domain Health Inspector is designed for people who manage multiple internet-facing assets but do not want to rely on scattered spreadsheets, manual DNS lookups, or separate command-line checks.
...
Domain Health Inspector supports local data backup and report export:
...
Domain Health Inspector is designed with a local-first approach. Domain lists and reports are stored in local app data, and backup files are created only when you choose to export them.
